...
app.service('crudService', function ($http) {
    ...
    this.GetUsers = function () {
        //return $http.get("/api/UserWPI/GetUsers");
        return $http.get("/Security/GetUsers");
    }

    this.CheckLoginName = function (pLoginName) {
        //return $http.get("/api/UserWPI/GetUsers");
        return $http.get("/User/CheckLoginName?pLoginName=" + pLoginName);
    }
